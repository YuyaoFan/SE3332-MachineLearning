...
def generate_answer(example, max_retries=3, retry_delay=2.0):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default="./results/docvqa_100_results_prompt_engineering.json")
